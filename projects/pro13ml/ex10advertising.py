...
print()
# 참고 : Cook's distance - 특정 데이터가 회귀 모델에 얼마나 영향을 주는지 확인
# 영향력 있는 관측치(이상치)를 탐지하는 진단 방법
# 데이터가 적을 때, 이상치가 의심스러울 때, 모델 결과가 이상하게 나올 때 ..
from statsmodels.stats.outliers_influence import OLSInfluence
cd, _ = OLSInfluence(lm).cooks_distance     # 쿡 거리, 인데스 반환
...
# 대부분 tv 광고비는 매우 높으나 sales가 낮다. - 모델이 예측하기 어려운 포인트들
...
# Time:                        11:58:43   Log-Likelihood:                -386.18
