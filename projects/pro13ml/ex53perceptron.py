...
ml = MLPClassifier(max_iter=100, hidden_layer_sizes=10, solver='adam', learning_rate_init=0.01, verbose=1).fit(feature,label)
print(ml)
...
print(x[:2])                    # [[ 0.80392642 -0.29140734][ 2.31443265 -0.12223813]]
print(y[:2])                    # [1 1]
