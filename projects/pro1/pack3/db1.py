# 개인용 Database : sqlite3 - python의 기본 모듈로 제공
# https://www.sqlite.org
# 모바일 기기, 임베디드 시스템 주로 사용한다.

import sqlite3

# conn = sqlite3.connect('exam.db')
conn = sqlite3.connect(':memory:')  #RAM에만 DB저장. 휘발성
try:
    ...
    cur.execute("insert into friends values(?,?,?)", ('신기해', '333-4444', '역삼 2동'))
