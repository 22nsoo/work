...
# 참고 키값 자동생성은 터미널창 > python -c "import secrets; print(secrets.token_hex(32))"
# 42bb2ecd4e7a300711d68d6a088b075dd3b656bfbc635b4348918f5df97b0a56

app.permanent_session_lifetime = timedelta(seconds=5)   #세션 만료 시간 설정 5초 설정
...
def setos():
    ...
    if favorite_os:
        session.permanent = True    #세션 만료 적용
